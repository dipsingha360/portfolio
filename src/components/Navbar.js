...
const Navbar = ({ footerNav }) => {
  ...
  return (
    ...
    >
      <div>
        <HashLink smooth to="#home" className="logo link-item" ref={link1Ref}>
          {footerNav ? "Go to to" : "Dip Singha"}
        </HashLink>
      </div>
      <ul className="links flex flex-col gap-3">
        ...
        <li>
          <a
            href="https://docs.google.com/document/d/15v_O6hjLhzeaZB7oEH2zANW_ta2T0EWz4jRCuN7Muog/edit?usp=sharing"
            target="_blank"
            rel="noreferrer"
            className="link-item"
            ref={link7Ref}
